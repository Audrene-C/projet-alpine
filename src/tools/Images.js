const Images = {
    logo: '/assets/sources-homepage/logo/logo-white.png',
    marque: {
        legende: {
            img: '/assets/configurateur/modele/selection/legende.png',
            blanc: {
                select: '/assets/configurateur/couleurs/selection/blanc.jpg',
                img: [
            ...
            bleu: {
                select: '/assets/configurateur/couleurs/selection/bleu.jpg',
                img: [
            ...
            noir: {
                select: '/assets/configurateur/couleurs/selection/noir.jpg',
                img: [
        ...
        pure: {
            img: '/assets/configurateur/modele/selection/pure.png',
            blanc: {                
                select: '/assets/configurateur/couleurs/selection/blanc.jpg',
                img: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_blanche-jante_standard.jpg',
                ...
                imgSerac: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_blanche-jante_serac.jpg',
                    '/assets/configurateur/modele/pure/modele_pure-couleur_blanche-jante_serac (2).jpg',
                    '/assets/configurateur/modele/pure/modele_pure-couleur_blanche-jante_serac (3).jpg',
                    '/assets/configurateur/modele/pure/modele_pure-couleur_blanche-jante_serac (4).jpg'
                ],
                jantes: {
            ...
            bleu: {
                select: '/assets/configurateur/couleurs/selection/bleu.jpg',
                img: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_bleu-jante_standard.jpg',
                ...
                imgSerac: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_bleu-jante_serac.jpg',
            ...
            noir: {
                select: '/assets/configurateur/couleurs/selection/noir.jpg',
                img: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_noire-jante_standard.jpg',
                ...
                imgSerac: [
                    '/assets/configurateur/modele/pure/modele_pure-couleur_noire-jante_serac.jpg',
    ...
    jantes: {
        legende: '/assets/configurateur/jantes/selection/jante-legende.jpg',
        serac: '/assets/configurateur/jantes/selection/jante-serac.jpg',
